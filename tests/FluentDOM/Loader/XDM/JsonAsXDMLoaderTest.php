...
namespace FluentDOM\Loader\XDM {
  ...
  /**
   * @covers \FluentDOM\Loader\XDM\JsonAsXDMLoader
   */
  class JsonAsXDMLoaderTest extends TestCase {

    public function testSupportsExpectingTrue(): void {
      $loader = new JsonAsXDMLoader();
    ...
    public function testLoadStoppingAtMaxDepth(): void {
      $loader = new JsonAsXDMLoader(0, 2);
      $this->assertXmlStringEqualsXmlString(
        '<?xml version="1.0" encoding="UTF-8"?>
        <map xmlns="http://www.w3.org/2005/xpath-functions">
          <array key="foo"/>
    ...
    public function testLoadWithEmptyArray(): void {
      $loader = new JsonAsXDMLoader(0, 1);
      $this->assertXmlStringEqualsXmlString(
        '<?xml version="1.0" encoding="UTF-8"?>
