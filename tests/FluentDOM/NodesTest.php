...
namespace FluentDOM {
  ...
  class NodesTest extends TestCase {
    ...
    public function testIsNodeExpectingNode($node) {
      $fd = new Nodes();
      $this->assertInstanceOf('DOMNode', $fd->isNode($node));
    }
    ...
    public function testIsNodeMatchingSelector() {
      ...
      $this->assertInstanceOf(
        'DOMNode',
        $fd->isNode(
          $fd->document->createElement('element'),
          FALSE,
          'self::element'
        )
      );
    ...
    public function testIsNodeExpectingNull($node, $ignoreTextNodes = FALSE) {
      $fd = new Nodes();
      $this->assertNull($fd->isNode($node, $ignoreTextNodes));
    }
     ...
     * @covers FluentDOM\Nodes::isNodeList
     */
    ...
    public function testIsNodeListExpectingNull() {
      $fd = new Nodes();
      $this->assertNull($fd->isNodeList('string'));
    }
    ...
    public function testIsCallable($callable) {
      ...
      $this->assertInternalType(
        'callable', $fd->isCallable($callable)
      );
    }
    ...
    public function testIsCallableWithGlobalFunctionExpectingCallable() {
      $fd = new Nodes();
      $this->assertInternalType(
        'callable', $fd->isCallable('strpos', TRUE)
      );
    }
    ...
    public function testIsCallableWithGlobalFunctionExpectingNull() {
      $fd = new Nodes();
      $this->assertNull($fd->isCallable('strpos', FALSE));
    }
    ...
    public function testIsCallableExpectingNull() {
      $fd = new Nodes();
      $this->assertNull($fd->isCallable(NULL));
    }
    ...
    public function testIsCallableExpectingException() {
      $fd = new Nodes();
      $this->setExpectedException('InvalidArgumentException');
      $fd->isCallable(NULL, FALSE, FALSE);
    }
  }
}